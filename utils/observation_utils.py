...
The environment is passed a function via the config.py file, and uses this function to calculate the observation of each
agent at each turn.
The different observations functions are implemented in this file.
"""
import numpy as np
from Domains.Taxis.multitaxienv.taxi_utils import rendering_utils
